...
import numpy as np
from src.utils import is_parallel, xywh2xyxy
...
class ComputeLoss:
    ...
    def __call__(self, p, targets):  # predictions, targets, model
        # p : bs na no ny nx --> bs na ny nx no
    ...
    def build_targets(self, p, targets):
        ...
        for i in range(self.nl):
            ...
            # xywh >> x1y1x2y2
            t_boxes_xyxy = xywh2xyxy(t_boxes)                                                   # n 6
            ...
            ymax_grid = torch.clamp(ymax.long(), min=0, max=nG0 - 1)                                # ymax_grid : num_targets
                
            allwidth = (ymax_grid - ymin_grid) + 1

            th1 = 0 # used in ablation                                                              # t : bs num_target 7 (object cls x y h w 0)
            obj_i = (allwidth >= th1)
