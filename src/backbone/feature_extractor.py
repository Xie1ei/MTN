...
class deepFeatureExtractor_EfficientNet(nn.Module):
    def __init__(self, architecture="EfficientNet-B5", lv6=False, lv5=False, lv4=False, lv3=False,pretrained=True):
        ...
        if architecture == "EfficientNet-B0":
            self.encoder = geffnet.tf_efficientnet_b0_ns(pretrained)
            ...
            self.encoder = geffnet.tf_efficientnet_b1_ns(pretrained)
            self.dimList = [16, 24, 40, 112, 1280] #5th feature is extracted after conv_head or bn2
            #self.dimList = [16, 24, 40, 112, 320] #5th feature is extracted after blocks[6]
        elif architecture == "EfficientNet-B2":
            self.encoder = geffnet.tf_efficientnet_b2_ns(pretrained)
            ...
            self.encoder = geffnet.tf_efficientnet_b3_ns(pretrained)
            ...
            self.encoder = geffnet.tf_efficientnet_b4_ns(pretrained)
            ...
            self.encoder = geffnet.tf_efficientnet_b5_ns(pretrained)
            ...
            self.encoder = geffnet.tf_efficientnet_b6_ns(pretrained)
            ...
            self.encoder = geffnet.tf_efficientnet_b7_ns(pretrained)
